...
- Pkg folder: [packages\retention-enforcement-jobs](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\retention-enforcement-jobs)
...
graph LR
  ...
  retention_enforcement_jobs["retention_enforcement_jobs"]:::center
  retention_enforcement_jobs -->|FK| data_retention_policies["data_retention_policies"]:::link
...
- Outbound (depends on): "data_retention_policies"
...
## Usage
- Install/upgrade schema: pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package retention-enforcement-jobs -Apply

...
| Pkg folder | [packages/retention-enforcement-jobs](https://github.com/blackcatacademy/blackcat-database/blob/main/packages/retention-enforcement-jobs) | Repo location |
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package retention-enforcement-jobs -Apply

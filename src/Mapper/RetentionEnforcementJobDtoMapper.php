...
namespace BlackCat\Database\Packages\RetentionEnforcementJobs\Mapper;

use BlackCat\Database\Packages\RetentionEnforcementJobs\Dto\RetentionEnforcementJobDto;
use BlackCat\Database\Packages\RetentionEnforcementJobs\Definitions;
use DateTimeZone;
use BlackCat\Database\Support\DtoHydrator;

/**
 * Bidirectional mapper between DB rows and DTO RetentionEnforcementJobDto:
 ...
 */
final class RetentionEnforcementJobDtoMapper
{
    /** @var array<string,string> Column -> DTO property */
    private const COL_TO_PROP = [ 'id' => 'id', 'policy_id' => 'policyId', 'scheduled_at' => 'scheduledAt', 'started_at' => 'startedAt', 'finished_at' => 'finishedAt', 'status' => 'status', 'processed_count' => 'processedCount', 'error' => 'error', 'created_at' => 'createdAt' ];

    /** @var string[] */
    private const BOOL_COLS   = [];
    /** @var string[] */
    private const INT_COLS    = [ 'id', 'policy_id', 'processed_count' ];
    /** @var string[] */
     ...
     * @return RetentionEnforcementJobDto
     */
    public static function fromRow(array $row): RetentionEnforcementJobDto
    {
        /** @var RetentionEnforcementJobDto */
        return DtoHydrator::fromRow(
            RetentionEnforcementJobDto::class,
            $row,
            self::COL_TO_PROP,
            self::BOOL_COLS,
            self::INT_COLS,
    ...
    public static function fromRowOrNull(?array $row): ?RetentionEnforcementJobDto
    {
     ...
     *
     * @param RetentionEnforcementJobDto   $dto
     * @param string[]|null   $onlyProps  optional whitelist of DTO properties to serialize
     * @return array<string,mixed>
     */
    public static function toRow(RetentionEnforcementJobDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(RetentionEnforcementJobDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(RetentionEnforcementJobDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,RetentionEnforcementJobDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,RetentionEnforcementJobDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(RetentionEnforcementJobDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,RetentionEnforcementJobDto>
     */

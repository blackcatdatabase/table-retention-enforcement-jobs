...
namespace BlackCat\Database\Packages\RetentionEnforcementJobs\Service;

use BlackCat\Core\Database;
use BlackCat\Database\Packages\RetentionEnforcementJobs\Dto\RetentionEnforcementJobDto;
use BlackCat\Database\Packages\RetentionEnforcementJobs\Mapper\RetentionEnforcementJobDtoMapper;
 ...
 */
final class RetentionEnforcementJobsAggregateService
{
    use ServiceHelpers;
    ...
    public function __construct(
        private Database $db, private RetentionEnforcementJobRepository $retentionEnforcementJobRepo
    ) {
        // Repository autowiring (generated)
        $this->repositories = [
  'retention_enforcement_jobs' => $this->retentionEnforcementJobRepo
];
    }
    ...
    protected function withRowLock(callable $locker, int|string|array $id, callable $fetch, string $mode = 'wait'): mixed
    {
        ...
        return $this->txn(function () use ($locker, $id, $fetch, $mode) {
            ...
            if (!$row) {
                ...
                throw new \BlackCat\Database\Packages\RetentionEnforcementJobs\ModuleException("Record {$idStr} not found for locking.");
            }

...
/**
 * Contract generated for RetentionEnforcementJob repositories.
 * Mirrors the public API of the generated repository so tests can type against the interface.
 */
interface RetentionEnforcementJobRepositoryInterface extends RepoContract, KeysetRepoContract
{
    // --- INSERT / BULK -------------------------------------------------------

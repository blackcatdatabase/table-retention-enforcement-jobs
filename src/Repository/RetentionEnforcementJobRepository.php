...
namespace BlackCat\Database\Packages\RetentionEnforcementJobs\Repository;
...
use BlackCat\Database\Packages\RetentionEnforcementJobs\Criteria;
use BlackCat\Database\Packages\RetentionEnforcementJobs\Dto\RetentionEnforcementJobDto as Dto;
use BlackCat\Database\Packages\RetentionEnforcementJobs\Mapper\RetentionEnforcementJobDtoMapper as RowMapper;
...
final class RetentionEnforcementJobRepository implements RepoContract, KeysetRepoContract
{
     ...
     */
    protected function def(): string { return \BlackCat\Database\Packages\RetentionEnforcementJobs\Definitions::class; }
    ...
    public function upsertMany(array $rows): int {
        ...
        if (class_exists(\BlackCat\Database\BulkUpsertRepository::class) && [] !== []) {
            $bulk = new \BlackCat\Database\BulkUpsertRepository($this->db, \BlackCat\Database\Packages\RetentionEnforcementJobs\Definitions::table());
    ...
    */
    ...
    /** @return array<string,mixed>|\BlackCat\Database\Packages\RetentionEnforcementJobs\Dto\RetentionEnforcementJobDto|null */
    public function getById(int $id, bool $asDto = false): array|\BlackCat\Database\Packages\RetentionEnforcementJobs\Dto\RetentionEnforcementJobDto|null {
        $row = $this->getByUnique([ 'id' => $id ]);
        if (!$asDto || !$row) return $row;
        return \BlackCat\Database\Packages\RetentionEnforcementJobs\Mapper\RetentionEnforcementJobDtoMapper::fromRow($row);
    }

...
final class RetentionEnforcementJobsModule implements ModuleInterface
{
    public function name(): string { return 'table-retention_enforcement_jobs'; }
    public function table(): string { return 'retention_enforcement_jobs'; }
    public function version(): string { return '1.0.0'; }

    /** @return string[] */
    public function dialects(): array { return [ 'mysql', 'postgres' ]; }
    /** @return string[] */
    public function dependencies(): array { return [ 'table-data_retention_policies' ]; }

    public static function contractView(): string { return 'vw_retention_enforcement_jobs'; }
...
SQL;
    ...
    public function status(Database $db, SqlDialect $d): array
    {
        ...
        $expectedIdx = [ 'idx_rej_status_sched' ];
        if ($d->isMysql()) {
    ...
    public function info(): array
    {
        return [
            ...
            'indexes'     => [ 'idx_rej_status_sched' ],
            'foreignKeys' => [ 'fk_rej_policy' ],
        ];
    }
}

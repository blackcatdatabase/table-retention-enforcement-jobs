...
final class Criteria extends BaseCriteria
{
    ...
    {
        return [ 'id', 'policy_id', 'scheduled_at', 'started_at', 'finished_at', 'status', 'processed_count', 'error', 'created_at' ];
    }
    ...
    {
        $x = [ 'id', 'policy_id', 'scheduled_at', 'started_at', 'finished_at', 'status', 'processed_count', 'error', 'created_at' ];
    ...
    protected function joinable(): array
    {
        ...
        return [ 'data_retention_policies' => 'j0' ];
    }
    ...
    public static function fromDb(
        ...
        if (\method_exists(\BlackCat\Database\Packages\RetentionEnforcementJobs\Definitions::class, 'softDeleteColumn')) {
            $soft = \BlackCat\Database\Packages\RetentionEnforcementJobs\Definitions::softDeleteColumn();

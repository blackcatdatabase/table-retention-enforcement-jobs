...
namespace BlackCat\Database\Packages\RetentionEnforcementJobs;
...
use BlackCat\Database\Packages\RetentionEnforcementJobs\Repository\RetentionEnforcementJobRepositoryInterface;
use BlackCat\Database\Packages\RetentionEnforcementJobs\Repository\RetentionEnforcementJobRepository as GeneratedRepository;
...
{
  private RetentionEnforcementJobRepositoryInterface $repo;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof RetentionEnforcementJobRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected RetentionEnforcementJobRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\RetentionEnforcementJobs\Dto\RetentionEnforcementJobDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\RetentionEnforcementJobs\Dto\RetentionEnforcementJobDto|null { return $this->repo->getById($id, $asDto); }

...
use BlackCat\Database\Packages\RetentionEnforcementJobs\Repository\RetentionEnforcementJobRepository;
...
{
    private RetentionEnforcementJobRepository $repo;

    public function __construct(private Database $db)
    {
        $this->repo = new RetentionEnforcementJobRepository($db);
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\RetentionEnforcementJobs\Dto\RetentionEnforcementJobDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\RetentionEnforcementJobs\Dto\RetentionEnforcementJobDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\RetentionEnforcementJobs\Dto\RetentionEnforcementJobDto|null
    {

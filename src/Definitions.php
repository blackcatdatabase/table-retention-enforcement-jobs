...
final class Definitions {
    // --- core metadata ---
    public static function table(): string { return 'retention_enforcement_jobs'; }
    public static function contractView(): string { return 'vw_retention_enforcement_jobs'; }
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'policy_id', 'scheduled_at', 'started_at', 'finished_at', 'status', 'processed_count', 'error', 'created_at' ]; }
    ...
    public static function intColumns(): array { return [ 'id', 'policy_id', 'processed_count' ]; }
